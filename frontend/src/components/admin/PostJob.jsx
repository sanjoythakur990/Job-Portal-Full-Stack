                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        <div>
                            ...
                            <Input
                                ...
                                className="focus-visible:ring-offset-0 focus-visibile:ring-0 my-1"
                            />
                        </div>
                        <div>
                        ...
                        {companies.length > 0 && (<Select onValueChange={selectChangeHandler}>
                            ...
                            <SelectContent>
                                {companies.map(company => <SelectItem value={company._id}>{company.name}</SelectItem>)}
                            </SelectContent>
                        </Select>)
                        }
                    </div>
                    {
                        loading ? <Button className='mt-4 w-full'><Loader2 className="h-4 w-4 mr-2 animate-spin" />Please Wait</Button> :
